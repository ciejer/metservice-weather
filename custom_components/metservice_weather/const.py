...
SENSOR_MAP_PUBLIC: Final[dict[str, str]] = {
    ...
    "hourly_skip": "layout.primary.slots.main.modules.2.graph.series.0.count",
    "hourly_obs": "layout.primary.slots.main.modules.2.graph.series.1.count",
    "hourly_bkp_temp": "layout.primary.slots.main.modules.1.graph.columns",
    "hourly_bkp_timestamp": "layout.primary.slots.main.modules.1.graph.columns",
    "hourly_bkp_skip": "layout.primary.slots.main.modules.1.graph.series.0.count",
    "hourly_bkp_obs": "layout.primary.slots.main.modules.1.graph.series.1.count",
